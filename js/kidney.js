...
//     tf.loadLayersModel('model/logReg.json')
//     .then(loadedModel =>{
//         model = loadedModel;
//     }).catch(error =>{
...
//         return predictedClass === 1 ? "Please Consult the Doctor immediately. It was too risky without consultation." : "There are no marks for Chronic Kidney Disease";
//     }
...
//             const predictedClass = predictionResult[0] > predictionResult[1] ? 0:1;
...
//     // Find the form within the modal and reset it
//     var form = calculatorModal.querySelector('form');
//     if (form) {
//         form.reset();
